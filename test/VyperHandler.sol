...
contract VyperHandler is Test {
    IVyperStableSwap pool;
    ...
    constructor(IVyperStableSwap _pool, address _tokenLP) {
        pool = _pool;
        ...
        for (uint256 i = 0; i < N_COINS; i++) {
            uint256 coinDecimal;
            coinDecimal = MockERC20(coins[i]).decimals();
    ...
    function exchange(uint256 i, uint256 j, uint256 dx) public {
        ...
        pool.exchange(int128(uint128(i)), int128(uint128(j)), dx, 0);
        vm.stopPrank();
        vm.warp(block.timestamp + 1);
    }
    ...
    /*//////////////////////////////////////////////////////////////
                    HELPER FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // function safeConvert(uint256 value) internal pure returns (int128) {
    //     require(value <= uint256(type(int128).max), "Value exceeds int128 range");
    //     return int128(value);
    // }
